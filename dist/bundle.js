  ...
  function create_if_block_1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			input.required = input_required_value = !/*$user*/ ctx[8];
  		...
  		p: function update(ctx, dirty) {
  			...
  			if (dirty & /*$user*/ 256 && input_required_value !== (input_required_value = !/*$user*/ ctx[8])) {
  ...
  function create_else_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(button, file, 83, 2, 1927);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_catch_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t2 = text("Try again");
  			attr_dev(span, "class", "alert svelte-1mrcfw8");
  			add_location(span, file, 74, 3, 1738);
  			attr_dev(button, "type", "submit");
  			button.disabled = button_disabled_value = !/*isComplete*/ ctx[11];
  			attr_dev(button, "class", "svelte-1mrcfw8");
  			add_location(button, file, 78, 3, 1832);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, span, anchor);
  			insert_dev(target, t1, anchor);
  ...
  function create_then_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(span, file, 68, 3, 1601);
  			attr_dev(button, "type", "button");
  			attr_dev(button, "class", "svelte-1mrcfw8");
  			add_location(button, file, 70, 3, 1642);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, span, anchor);
  			insert_dev(target, t1, anchor);
  ...
  function create_pending_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(span, "class", "svelte-1mrcfw8");
  			add_location(span, file, 66, 3, 1561);
  		},
  		m: function mount(target, anchor) {
  			insert_dev(target, span, anchor);
  		},
